...
public class NetworkRobotControllerPrototypeCustom : NetworkTransform
{
    ...
    //Hier eventuell die 0 mit this.transform.rotation.x und z austauschen
    public void Rotate(float rotationY)
    {
        transform.Rotate(0, rotationY * Runner.DeltaTime * rotationSpeed, 0);
    }

    public void TiltAndRoll(float rotationX, float rotationZ)
    {
        transform.Rotate(rotationX * Runner.DeltaTime * rotationSpeed, 0, rotationZ * Runner.DeltaTime * rotationSpeed);
    }
}